...
def sample():
    return [
        {"subject_id":"A","subject_name":"Alpha","dimension":"AGENCY_ONTOLOGY","facet":"ancestors","state":"PRESENT","source_id":"S1"},
        {"subject_id":"A","subject_name":"Alpha","dimension":"RITUAL_GRAMMAR","facet":"offering","state":"PRESENT","source_id":"S1"},
        {"subject_id":"B","subject_name":"Beta","dimension":"AGENCY_ONTOLOGY","facet":"ancestors","state":"PRESENT","source_id":"S2"},
        {"subject_id":"B","subject_name":"Beta","dimension":"ALTERED_STATE_INDUCTION","facet":"drumming","state":"PRESENT","source_id":"S2"},
        {"subject_id":"C","subject_name":"Gamma","dimension":"AGENCY_ONTOLOGY","facet":"ancestors","state":"UNKNOWN","source_id":"S3"},
...
def test_conditional_mapping_does_not_enter_profile():
