const CACHE='innergroup-workshop-v2';
const CORE=['./','./index.html','./styles.css','./app.js','./config/vattenfall.json','./assets/app-icon.svg','./assets/innergroup-logo-white.svg','./assets/hero-stage.svg','./assets/seedling.svg'];
